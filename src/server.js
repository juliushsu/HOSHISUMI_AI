...
import adminSystemAiSettingsRouter from './routes/adminSystemAiSettings.js';
...
app.use('/api/admin/system/ai-settings', requireStagingFeature, express.json({ limit: '1mb' }), requireAuth, adminSystemAiSettingsRouter);
